...
$nl=(string)$nl;
$title=$nl.".".$titlename;
$logoname=$_FILES['addfile']['name'];
$logo=$nl.".".$logoname;
$dir="../file/";
$logopath=$dir.$logo;
move_uploaded_file($_FILES["addfile"]["tmp_name"],$logopath);

$sql = "INSERT INTO info(ID,kind,type,name,description,start,end,time) VALUES ('$id','2','$type','$title','$logo','$start','$end',NOW())";
